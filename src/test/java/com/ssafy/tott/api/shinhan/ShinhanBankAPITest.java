...
class ShinhanBankAPITest {
    ...
    void fetchTransfer1Test() {
        ...
        /* When */
        ShinhanBankAPIResponse response = shinhanBankAPI
                .fetchTransfer1API(request.getBankCode(), request.getAccountNumber(), "1234 전세역전");
    ...
    void fetchSearchNameTest() {
        ...
        /* When */
        ShinhanBankAPIResponse response = shinhanBankAPI
                .fetchSearchNameAPI(request.getBankCode(), request.getAccountNumber());
