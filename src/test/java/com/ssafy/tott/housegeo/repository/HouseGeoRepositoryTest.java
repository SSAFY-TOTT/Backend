...
public class HouseGeoRepositoryTest {
    ...
    void findHouseGeoWhenExist() {
        Optional<HouseGeo> findHouseGeto = houseGeoRepository.findByMainNumberAndSubNumber(Integer.parseInt(row.getBobn()), Integer.parseInt(row.getBubn()));
        assertTrue(findHouseGeto.isPresent());
