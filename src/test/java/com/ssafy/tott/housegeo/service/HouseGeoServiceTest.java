...
public class HouseGeoServiceTest {
  ...
  private final HouseGeo houseGeo =
      HouseGeo.builder()
          ...
          .region(region)
          .build();
  @InjectMocks private HouseGeoService houseGeoService;
  @Mock private HouseGeoRepository houseGeoRepository;
  @Mock private KakaoMapFetchAPI kakaoMapFetchAPI;
  @Spy private HouseGeoMapper houseGeoMapper;
