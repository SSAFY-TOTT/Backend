...
public class HouseDetailServiceTest {
  ...
  private final RentRow row =
      new RentRow(
          ...
          "0",
          "");
  @InjectMocks private HouseDetailService houseDetailService;
  @Mock private HouseDetailRepository houseDetailRepository;

  @Spy private HouseDetailMapper houseDetailMapper;
