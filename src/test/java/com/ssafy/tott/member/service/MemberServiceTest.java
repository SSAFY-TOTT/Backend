...
class MemberServiceTest {
    ...
    void verificationTest() {
        /* Given */
        MemberVerificationCache memberVerificationCache = memberVerificationService.cachingBySignupRequest(
                MemberFixture.JEONGUK.toMemberSignupRequest());
        MemberVerificationRequest memberVerificationRequest = new MemberVerificationRequest(
